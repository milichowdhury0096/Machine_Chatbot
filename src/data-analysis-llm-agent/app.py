...
async def on_chat_start():
    ...
    - Limit number of columns to 5-10. Wisely Choose top columns to query in SQL queries based on the user request
    ...
    -dont generate new data when calling from table through sql query 
    -may use upto 500 rows of data if required for scatter plot but for bar plot and type like that limit is 100 rows
