...
def handle_message(message):
    ...
    cl.Message(content=response).send()  # Use Message class to send the response

# Optional: Define a callback for chat start if needed
@cl.on_chat_start
def on_chat_start():
    cl.Message(content="Welcome to the chatbot! How can I assist you today?").send()  # Send welcome message
